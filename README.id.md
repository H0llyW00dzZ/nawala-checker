...
- [ ] Implementasikan server [JSON-RPC 2.0](https://www.jsonrpc.org/specification) murni (dibundel dalam repositori ini) untuk integrasi lintas bahasa melalui stdio atau TCP, serupa cara kerja MCP namun menggunakan protokol kawat JSON-RPC standar.
